    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-tickets"></i> 客户收支统计列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
                    ...
                    <el-row>
                        <el-col>
                            ...
                            <div style="float: right">
                                <el-form-item label="客户账号：" style="padding: 0px 30px">
                                  123456
                                </el-form-item>
                      ...
                      <div style="border: 1px solid #ccc">
                          <div style="padding: 10px;" class="rightContent">
                              <div>
                                  ...
                                  <span style="color:#333;font-size: 18px;font-weight: 800">运单号：123456</span>
                                  <span style="float: right;padding-right:10px;font-family: cursive;font-weight: 800"> <img src="../../assets/img/user.png" ></img>孟健康</span>
                              ...
                              <div >
                                  ...
                                  <span style="float: right;font-family: cursive ;padding-right:23px;font-weight: 800" ><img src="../../assets/img/car.png" ></img>火车</span>
                              ...
                              <div class="detailesContent">
                                  <div style="margin-top: 15px">
                                      ...
                                      <el-button  type="success" plain :loading="true">货物信息</el-button>
                                  ...
                                  <div style="margin-top: 15px">
                                      <el-button  type="primary" plain :loading="true">包装信息</el-button>
                                      <p style="text-indent: 20px;margin: 20px 0;">包装材料：</p>
                                      <p style="text-indent: 20px;margin: 20px 0;">包装尺寸：</p>

                                  </div>
                                  <div style="margin-top: 15px">
                                      <el-button  type="warning" plain :loading="true">发件人信息</el-button>
                                  ...
                                  <div style="margin-top: 15px">
                                      <el-button  type="primary" plain :loading="true">收件人信息</el-button>
                                  ...
                                  <div style="margin: 15px 0">
                                      <el-button  type="danger" plain :loading="true">投保信息</el-button>
                                      <div style="margin-top: 15px">
                                          <span style="margin: 20px 0 20px 20px;  color:#666;font-size: 16px;">是否投保：</span>
                                          <span style="margin: 0px 20px 20px 0px;float: right;  color:#666; font-size: 16px;">投保金额：1231233</span>
                                      </div>

                                  </div>
                                  <div style="color:#999999;font-size: 16px;height: 40px;line-height: 40px;">注意事项……</div>
            ...
            <el-row :gutter="24">
                <el-col :span="isFirst ? 24 :15">
                    ...
                    <!--    <el-table-column
                        ...
                        <el-table-column prop="BillNumber" label="运单号码" align="center" class-name="curstomNum" label-class-name="aaa"></el-table-column>
                        ...
                        <el-table-column prop="WDQJ" label="温度区间" align="center" :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column label="收入" align="center" :show-overflow-tooltip="true">
                            <template slot-scope="scope">
                                <span>{{scope.row.Total  | rounding}}</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="Pay" label="支出" align="center" :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column prop="Profit" label="利润" align="center" :show-overflow-tooltip="true"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            jumpDetails(row, column, cell, event){
                ...
                if (column.label == "运单号码") {
                        ...
                        let obj = {
                            ...
                            BillNumber:this.BillNumber //公司名稱
                        }
                        ...
                        window.localStorage.setItem("BillNumber", row.BillNumber);
                    this.$router.push("/StatementExpenditure");
                }
            },
            //已结算
            ...
            dataExport() {
                ...
                new Promise((resolve, reject) => {
                    ...
                    require.ensure([], () => {
                        ...
                        export_json_to_excel(tHeader, data, "客户收支统计明细表");  // 这是  excel文件名
                    });
                });
            ...
            getData() {
                ...
                this.$axios
                    .post(
                        "http://www.zjcoldcloud.com/zhanghaining/tms/public/index.php/statistical/bops",
                        {
                            Page: this.cur_page,//当前页码
                            PageSize: this.limit,//每页条数
