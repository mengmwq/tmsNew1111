<template>
    <div class="table">
        ...
        >
            ...
            <el-table-column prop="ID" label="承运单号" align="center"></el-table-column>
            <el-table-column prop="GetCompany" label="运单号码" align="center" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="Condition" label="客户账号" align="center"></el-table-column>
            <el-table-column prop="BillNumber" label="班次" align="center" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="BillNumber" label="货物名称" align="center" :show-overflow-tooltip="true"></el-table-column>
            ...
            <el-table-column prop="BillNumber" label="承运费用" align="center" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="BillNumber" label="结算方式" align="center" :show-overflow-tooltip="true"   ></el-table-column>
            <el-table-column prop="BillNumber" label="录入人" align="center" :show-overflow-tooltip="true"   ></el-table-column>
            <el-table-column prop="BillNumber" label="录入时间" align="center" :show-overflow-tooltip="true"   ></el-table-column>
