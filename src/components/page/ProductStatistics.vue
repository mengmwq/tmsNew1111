...
export default {
  ...
  methods: {
    ...
    getSearch() {
      // 点击  搜索      也是走的  getTableData   这个方法  传参数 

      // 我先 给你写死  到时候 有了接口 就是传参数 走getTableData   就完事  不用这么麻烦
